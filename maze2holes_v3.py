...
pin_led = 10 # to light the led of stim from detector #1
pin2_led = 6 # to light the led of stim from detector #2
      ...
      if (board.analog[pin].read() > 0.75) or (board.analog[pin2].read() > 0.75):
        ...
        if (board.analog[pin2].read() > 0.75):
          ...
          if counter2 < stim_len and visited_hole_1:
            board.digital[pin_out].write(1)
            board.digital[pin2_led].write(1)
            print('stim 2')
            keep_stimulus2 = True
            ...
            visited_hole_2 = True
            board.digital[pin_out].write(0)
            board.digital[pin2_led].write(0)
            counter2 = 0
            keep_stimulus2 = False
